...
// Metric Card Component - PREMIUM MINIMAL STYLE
const MetricCard = ({ icon: Icon, label, value, color = "#3B82F6" }) => {
  return (
...
export default function ActionLogsDashboard({ onBack }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      {/* Toast Notification - PREMIUM MINIMAL STYLE */}
      {showToast && (
        <div className="fixed top-4 right-4 z-50">
          <div className="flex items-center gap-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 px-4 py-3 rounded-xl shadow-md">
      ...
      {/* Main Container - PREMIUM MINIMAL STYLE */}
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden m-4 sm:m-6 lg:m-8">
        {/* Header Section - PREMIUM MINIMAL STYLE */}
        <div className="bg-white dark:bg-gray-800 px-6 py-5 border-b border-gray-200 dark:border-gray-700">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              {/* Total Badge */}
              <div className="flex items-center gap-2 bg-gray-100 dark:bg-gray-700 px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-600">
              ...
              {/* View Density Toggle */}
              <div className="hidden sm:flex items-center bg-gray-100 dark:bg-gray-700 rounded-xl p-1 border border-gray-200 dark:border-gray-600">
              ...
              <div className="relative">
                <button
                  ...
                  className="p-2 text-gray-600 dark:text-gray-400 rounded-xl"
                  ...
                  <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl z-50 p-3">
                    ...
                    <div className="space-y-2 max-h-96 overflow-y-auto">
                      {columns.map((col) => (
                        <label
                          key={col.key}
                          className="flex items-center gap-2 cursor-pointer bg-white dark:bg-gray-800 p-2 rounded-lg "
                        >
                          <input
                            type="checkbox"
              ...
              <button
                ...
                disabled={loading}
                className="p-2 text-gray-600 dark:text-gray-400 rounded-xl disabled:opacity-50 disabled:cursor-not-allowed"
                title="Refresh"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-xl shadow-sm font-medium text-sm"
              >
          ...
          {/* Summary Metrics - PREMIUM MINIMAL STYLE */}
        ...
        {/* Filters Section - PREMIUM MINIMAL STYLE */}
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="flex items-center gap-2">
              ...
              {(searchQuery ||
                ...
                selectedAccount !== "all" ||
                profitFilter !== "all") && (
                <span className="px-2 py-0.5 bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-400 text-xs font-medium rounded-full">
                  Active
                </span>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-6 gap-3">
              ...
              <div className="lg:col-span-2">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-200 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
              </div>
              ...
              <div className="relative">
                <button
                  ...
                  className="w-full flex items-center justify-between gap-2 px-4 py-2.5 border border-gray-200 dark:border-gray-600 rounded-xl text-sm bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-medium"
                >
                  <div className="flex items-center gap-2">
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between mb-4">
                              <button
                                ...
                                className="p-1.5 bg-transparent rounded-lg "
                              >
                              ...
                              {generateCalendar(currentMonth).map((date, index) => {
                                ...
                                return (
                                  <button
                                    ...
                                    className={`text-sm p-2 text-center rounded-lg ${classes}`}
                                  >
                                    {date.getDate()}
                                  </button>
                                );
                        ...
                        <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                          ...
                          <div className="flex gap-2">
                            <button
                              ...
                              className="px-4 py-2 text-sm text-gray-700 dark:text-gray-300 bg-transparent rounded-lg "
                            >
                              Cancel
                            </button>
                            <button
                              onClick={handleApplyDateFilter}
                              className="px-4 py-2 text-sm bg-blue-600 text-white rounded-lg shadow-sm"
                            >
                              Apply
                            </button>
                          </div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full px-4 py-2.5 text-sm border border-gray-200 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent  cursor-pointer font-medium appearance-none"
                >
        ...
        <div className="relative min-h-[400px]">
          ...
          {loading && initialLoad && (
            <div className="absolute inset-0 flex items-center justify-center z-40 bg-white dark:bg-gray-800">
            ...
            <div className="absolute inset-0 flex items-center justify-center z-40 bg-white dark:bg-gray-800 ">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 p-6">
                <div className="flex flex-col items-center gap-3">
                  <div className="relative">
                    <div className="animate-spin rounded-full h-12 w-12 border-3 border-gray-200 dark:border-gray-700 border-t-blue-600"></div>
                    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            ...
            <>
                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <select
                      ...
                      className="border border-gray-200 dark:border-gray-600 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-medium"
                    >
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                      {columns.map((column) => {
                        ...
                        return (
                          <th
                            key={column.key}
                            className={`${density.padding} text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider ${column.align === "right" ? "text-right" : "text-left"} ${column.sortable ? "cursor-pointer select-none bg-transparent " : ""}`}
                    ...
                    {paginatedLogs.map((row, i) => (
                      ...
                      >
                        ...
                        {visibleColumns.reason && (
                          ...
                          >
                            {row.reason ? (
                              <div className="text-xs bg-gray-50 dark:bg-gray-900 px-3 py-1.5 rounded-lg border border-gray-100 dark:border-gray-700 line-clamp-2">
                                {row.reason}
                              </div>
                            ) : (
                              "—"
                  ...
                  <tfoot className="bg-gray-100 dark:bg-gray-700 border-t-2 border-gray-300 dark:border-gray-600 font-semibold">
                    <tr>
                      <td
                        colSpan={
                          columns.filter(
                      ...
                      {Array.from({ length: Math.min(5, totalPages) }).map((_, i) => {
                        ...
                        return (
                          <button
                            ...
                            className={`min-w-[40px] px-3 py-2 text-sm font-medium rounded-lg ${
                              currentPage === pageNum
          ...
          {!loading && err && (
            <div className="p-16 flex justify-center items-center">
              <div className="flex flex-col items-center text-center max-w-md">
                <div className="h-20 w-20 bg-rose-100 dark:bg-rose-900 rounded-2xl flex items-center justify-center mb-4">
                ...
                <button
                  onClick={fetchAllLogsAllTime}
                  className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-xl text-sm font-medium shadow-sm"
                >
