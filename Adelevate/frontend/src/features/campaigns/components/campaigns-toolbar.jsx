...
const PREDEFINED_TAGS = ["Mythili" , "Naga" , "Shanker" , "Ramanan" , "Jai" , "ArunS" , "naveen" , "Ashwin" , "Raju" , "Sudhanshu" ,"Hari" , "Gokulraj"]
  ...
  return (
      <section aria-label="Filters" className="flex flex-col gap-2 rounded-md border bg-white p-3 shadow-sm">
        <div className="flex flex-wrap items-center gap-2">
          {/* Date Picker */}
          <div>
            <DatePickerToggle initialSelection={dateRange} onChange={(newRange) => setDateRange(newRange)} />
          </div>
          ...
          <div className="relative">
            ...
            >
              ...
              {selectedPlatforms.length > 0 ? (
                  <span className="text-xs font-medium text-blue-600">{selectedPlatforms.length} selected</span>
              ) : (
            ...
            {showPlatformMenu && (
                <>
                  ...
                  <div className="absolute left-0 z-40 mt-1 w-56 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                    <div className="p-2">
                      <div className="mb-1 px-3 py-2 text-xs font-semibold text-gray-500">Select platforms...</div>
            ...
            {showTagsMenu && (
                <>
                  ...
                  <div className="absolute left-0 z-40 mt-1 w-48 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                    <div className="p-2">
                      <div className="mb-1 px-3 py-2 text-xs font-semibold text-gray-500">Select a tag...</div>
                      {PREDEFINED_TAGS.map((tag) => (
                          <button
                              ...
                              className={`w-full text-left rounded px-3 py-2 text-sm hover:bg-gray-100 ${
                                  tags === tag ? "bg-blue-50 text-blue-600 font-medium" : "text-gray-700"
                              }`}
                          >
                            {tag}
                          </button>
